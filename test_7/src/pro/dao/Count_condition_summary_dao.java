...
public class Count_condition_summary_dao {
	...
	public ArrayList<Count_condition_summary> getsummary(String cont_name,String pro_name,String daiwei_unit,String dev_type_id,String dev_appli_sta,
		...
		String sqlString = "select asset_id,allo_info,dev_mod,daiwei_unit,dev_appli_sta,DaiWei_cont_peri,name,maint_period,maint_end_time,money from asset_all1 WHERE (cont_name LIKE ? or cont_name is null) AND (pro_name LIKE ? or pro_name is null) AND (daiwei_unit LIKE ? or daiwei_unit is null)  AND (asset_id LIKE ? or asset_id is null) AND (dev_appli_sta LIKE ? or dev_appli_sta is null) AND (asset_attribute LIKE ? or asset_attribute is null) AND (asset_status LIKE ? or asset_status is null) AND (asset_use_status LIKE ? or asset_use_status is null) AND (asset_acq_type LIKE ? or asset_acq_type is null)";
	...
	public static void main(String[] args) {
		...
		Count_condition_summary_dao cc=new Count_condition_summary_dao();
		cc.getsummary("%","%","%","%","%","%","%","%","%" );
